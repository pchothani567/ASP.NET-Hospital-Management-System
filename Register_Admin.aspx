<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Register_Admin.aspx.cs" Inherits="Project_Hospital.Admin.Register_Admin" %>
...
<body>
    ...
    <asp:Label ID="Label2" runat="server" CssClass="custom-label" Text="Email"></asp:Label>
    <asp:TextBox ID="txteml" runat="server" CssClass="input-box" Placeholder="Email"></asp:TextBox>

    <asp:Label ID="Label3" runat="server" CssClass="custom-label" Text="Password"></asp:Label>
    <asp:TextBox ID="txtpwd" runat="server" CssClass="input-box" TextMode="Password" Placeholder="Password"></asp:TextBox>

    <asp:Label ID="Label4" runat="server" CssClass="custom-label" Text="Select Role"></asp:Label>
    ...
    <asp:Button ID="Regbtn" runat="server" Text="Register" CssClass="register-btn" OnClick="Button1_Click"  />

    <div class="login-link">
                Already an Account? <a href="Login_Admin.aspx">Login</a>
            </div>
