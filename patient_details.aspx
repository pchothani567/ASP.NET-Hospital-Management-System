...
<asp:Content ID="Content3" runat="server" contentplaceholderid="ContentPlaceHolder2">
    ...
    <div class="banner-section">
      <div class="container text-center wow fadeInUp">
        ...
        <h1 class="font-weight-normal">Patient Details</h1>
      </div> <!-- .container -->
    </div> <!-- .banner-section -->
  </div> <!-- .page-banner -->
    ...
    <%-- <h1 class="text-center wow fadeInUp">Patient Details</h1>  --%>
    <br /><br />
...
<br /><br />
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" OnRowCommand="GridView1_RowCommand">
        <Columns>
            ...
            <asp:TemplateField HeaderText="Mstatus">
                <ItemTemplate>
                    <asp:Label ID="Label8" runat="server" Text='<%# Eval("Mstatus") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
            ...
            <asp:TemplateField HeaderText="InsCompany">
                <ItemTemplate>
                    <asp:Label ID="Label10" runat="server" Text='<%# Eval("InsCompany") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="InsId">
                <ItemTemplate>
                    <asp:Label ID="Label11" runat="server" Text='<%# Eval("InsId") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
